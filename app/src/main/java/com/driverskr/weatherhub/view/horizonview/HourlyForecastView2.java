package com.driverskr.weatherhub.view.horizonview;

import static com.driverskr.lib.extension.LogKt.logE;
...
import com.driverskr.weatherhub.bean.Hourly;
import com.driverskr.weatherhub.utils.BitmapUtil;
...
public class HourlyForecastView2 extends View {
    ...
    private static final String TAG = "HourlyForecastView2";
...
//                int Y = getTempBarY(i);
                ...
                if (Constant.APP_SETTING_UNIT.equals("hua")) {
        ...
        for (int i = 0; i < hourlyWeatherList.size(); i++) {
            ...
            if (ITEM_SIZE > 8) {
                if (i % 2 == 0) {
                    ...
                    canvas.drawText(substring, w, textY, textPaint);
                }
            } else {
                textPaint.setTextAlign(Paint.Align.CENTER);
                if (i == 0) {
