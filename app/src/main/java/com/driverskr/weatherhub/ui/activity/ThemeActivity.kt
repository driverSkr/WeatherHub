...
import com.driverskr.weatherhub.databinding.ActivityThemeBinding
import com.driverskr.weatherhub.ui.activity.vm.ThemeViewModel
...
class ThemeActivity: BaseVmActivity<ActivityThemeBinding, ThemeViewModel>() {
    ...
    private fun setSelected(index: Int) {
        if (index == 1) {
            ...
            mBinding.llColorful.background = resources.getDrawable(R.drawable.shape_theme_bg_selected)
        } else {
            mBinding.llDefault.background = resources.getDrawable(R.drawable.shape_theme_bg_selected)
