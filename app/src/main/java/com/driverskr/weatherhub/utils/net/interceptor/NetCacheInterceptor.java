package com.driverskr.weatherhub.utils.net.interceptor;
...
public class NetCacheInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (request.header("Cache-Control") != null && !Objects.requireNonNull(request.header("Cache-Control")).isEmpty()) {
