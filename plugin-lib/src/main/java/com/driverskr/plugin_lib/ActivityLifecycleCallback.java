package com.driverskr.plugin_lib;

import static com.driverskr.lib.extension.LogKt.logD;
...
//        LayoutInflaterCompat.setFactory2(layoutInflater, skinLayoutInflaterFactory);
        ...
        logD("ActivityLifecycleCallback","onActivityCreated " + activity.getComponentName().getClassName() + " addObserver");
    ...
    public void onActivityDestroyed(Activity activity) {
        ...
        logD("ActivityLifecycleCallback","onActivityDestroyed " + activity.getComponentName().getClassName() + " deleteObserver");
    }
}
